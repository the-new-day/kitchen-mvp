// Package postgres keeps the books of the venue: its dishes, the orders it has
// been given and the events it has already taken. The venue owns this database
// alone -- the platform neither knows nor creates it.
package postgres
...
// DB is the connection pool of the venue database.
type DB struct {
	pool *pgxpool.Pool
	log  *slog.Logger
}
