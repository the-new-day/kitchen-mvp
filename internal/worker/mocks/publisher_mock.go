...
func (_mock *MockPublisher) Publish(ctx context.Context, message outbox.Pending) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, outbox.Pending) error); ok {
...
func (_e *MockPublisher_Expecter) Publish(ctx any, message any) *MockPublisher_Publish_Call {
	return &MockPublisher_Publish_Call{Call: _e.mock.On("Publish", ctx, message)}
}

func (_c *MockPublisher_Publish_Call) Run(run func(ctx context.Context, message outbox.Pending)) *MockPublisher_Publish_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 outbox.Pending
		if args[1] != nil {
			arg1 = args[1].(outbox.Pending)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockPublisher_Publish_Call) RunAndReturn(run func(ctx context.Context, message outbox.Pending) error) *MockPublisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
