...
// InboxRepo remembers the events the consumers of the platform have taken.
...
// Remember marks an event as taken by a consumer and reports whether it is the
// first time. It is meant to be called in the transaction of the work the
// event causes, so that a redelivery finds the mark exactly when it finds the
// work already done.
