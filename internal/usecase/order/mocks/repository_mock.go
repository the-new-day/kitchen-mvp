...
// History provides a mock function for the type MockRepository
func (_mock *MockRepository) History(ctx context.Context, orderID uuid.UUID, after int64) ([]order.StatusEntry, error) {
	ret := _mock.Called(ctx, orderID, after)

	if len(ret) == 0 {
		panic("no return value specified for History")
	}

	var r0 []order.StatusEntry
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, int64) ([]order.StatusEntry, error)); ok {
		return returnFunc(ctx, orderID, after)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, int64) []order.StatusEntry); ok {
		r0 = returnFunc(ctx, orderID, after)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]order.StatusEntry)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, uuid.UUID, int64) error); ok {
		r1 = returnFunc(ctx, orderID, after)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
//   - orderID uuid.UUID
//   - after int64
func (_e *MockRepository_Expecter) History(ctx any, orderID any, after any) *MockRepository_History_Call {
	return &MockRepository_History_Call{Call: _e.mock.On("History", ctx, orderID, after)}
}

func (_c *MockRepository_History_Call) Run(run func(ctx context.Context, orderID uuid.UUID, after int64)) *MockRepository_History_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_History_Call) Return(statusEntrys []order.StatusEntry, err error) *MockRepository_History_Call {
	_c.Call.Return(statusEntrys, err)
	return _c
}

func (_c *MockRepository_History_Call) RunAndReturn(run func(ctx context.Context, orderID uuid.UUID, after int64) ([]order.StatusEntry, error)) *MockRepository_History_Call {
	_c.Call.Return(run)
	return _c
}
